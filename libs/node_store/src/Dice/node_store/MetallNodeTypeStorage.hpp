 ...
 */
	...
	struct MetallNodeTypeStorage {
		...
		tsl::sparse_map<rdf4cpp::rdf::storage::node::identifier::NodeID, Backend_ptr, NodeIDHash, std::equal_to<>,
						metall_manager::allocator_type<std::pair<rdf4cpp::rdf::storage::node::identifier::NodeID, Backend_ptr>>>
				id2data;
		tsl::sparse_map<Backend_ptr, rdf4cpp::rdf::storage::node::identifier::NodeID, BackendTypeHash, BackendTypeEqual,
