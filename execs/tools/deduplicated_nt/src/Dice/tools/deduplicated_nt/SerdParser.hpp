#ifndef TENTRIS_SERDPARSER_HPP
#define TENTRIS_SERDPARSER_HPP
...
namespace Dice::tools::rdf2ids::serd_parser {
	...
	using TripleParsed_callback = std::function<void(rdf4cpp::rdf::Node, rdf4cpp::rdf::Node, rdf4cpp::rdf::Node)>;

	struct SerdHandle {
		robin_hood::unordered_map<std::string, std::string> prefixes;
		TripleParsed_callback add_triple_callback;
	};
