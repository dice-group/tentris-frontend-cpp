...
namespace dice::tests::sparql {
	...
	TEST_SUITE("SPARQL Function Queries") {
		...
		GENERATE_SPARQL_TEST_CASE(const_url, "data.ttl", "strlang01.rq", "strlang01.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "data.ttl", "strlang02.rq", "strlang02.srx", false);
		...
		/* STRSTARTS */
		GENERATE_SPARQL_TEST_CASE(const_url, "data.ttl", "starts01.rq", "starts01.srx", false);
		/* STRENDS */
		GENERATE_SPARQL_TEST_CASE(const_url, "data.ttl", "ends01.rq", "ends01.srx", false);
		/* CONTAINS */
		GENERATE_SPARQL_TEST_CASE(const_url, "data.ttl", "contains01.rq", "contains01.srx", false);
	}
