...
namespace dice::tests::sparql {
	...
	TEST_SUITE("SPARQL EXISTS Queries") {
		...
		GENERATE_SPARQL_TEST_CASE(const_url, "exists01.ttl", "exists01.rq", "exists01.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "exists01.ttl", "exists02.rq", "exists02.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "exists01.ttl", "exists04.rq", "exists04.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "exists01.ttl", "exists05.rq", "exists05.srx", false);
	}
