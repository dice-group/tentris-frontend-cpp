...
namespace dice::tests::sparql {
	...
	TEST_SUITE("SPARQL Queries with Expressions in Projections") {
		...
		GENERATE_SPARQL_TEST_CASE(const_url, "projexp01.ttl", "projexp01.rq", "projexp01.srx", false);
		...
		GENERATE_SPARQL_TEST_CASE(const_url, "projexp05.ttl", "projexp05.rq", "projexp05.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "projexp06.ttl", "projexp06.rq", "projexp06.srx", false);
		GENERATE_SPARQL_TEST_CASE(const_url, "projexp07.ttl", "projexp07.rq", "projexp07.srx", false);
	}
